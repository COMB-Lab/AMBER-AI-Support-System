...
from airflow.airflow.dags.Scaping import scrape_new_data  
...
default_args = {
    ...
    "email": ["airflow-alerts@example.com"],  # optional
    "email_on_failure": False,  # set to True if you configure email alerts
