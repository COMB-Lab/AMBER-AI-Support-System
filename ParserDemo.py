...
input2 = pathlib.Path("data/html/202204/0000.html")
output = pathlib.Path("data/json/202204/0000.json")

# Read HTML content from a file
with open(input2, "r") as html_file:
    html = html_file.read()
...
# 1. Message ID
# This is the year
year_month = input2.parent.name
message_num = input2.stem
