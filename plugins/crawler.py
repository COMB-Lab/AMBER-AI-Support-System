...
import os
OUTPUT_DIR = pathlib.Path(os.environ.get("AMBER_DATA_ROOT", "/opt/chromadb/data/data")) / "html"
...
def scrape_month_code(year_month: str):
    # year_month like "202204"
    month_url = f"{BASE_URL}{year_month}/"
