...
class AmberChromaAPI:
    def __init__(self, db_path="/opt/chromadb/data/amber_chroma_db", collection_name="amber_messages"):
    ...
    while True:
        ...
        if choice == "1":
            ...
            if setup_choice == "a":
                ...
                db_name = input("Database folder (default: /opt/chromadb/data/amber_chroma_db): ").strip() or "/opt/chromadb/data/amber_chroma_db"
